    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/pessoa/{id_pessoa}").permitAll()
                        .requestMatchers(HttpMethod.POST, "/pessoa/create").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/pessoa/update/{id_pessoa}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/pessoa/delete/{id_pessoa}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/livro/all").permitAll()
                        .requestMatchers(HttpMethod.GET, "/livro/{id_livro}").permitAll()
